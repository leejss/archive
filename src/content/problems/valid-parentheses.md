...
한번 열린 괄호는 반드시 닫혀야 하는데, 가장 늦게 열린 괄호가 가장 빨리 닫혀야 한다. 가장 늦은 것을 가장 빠르게 처리해야 할때 이를 처리할 수 있는 데이터 구조로 스택을 떠올릴 수 있다. 스택은 Last In First Out(후입선출) 특성을 지닌다. 스택에서 꺼낸 무언가는 가장 최근에 넣은 무언가다. 이러한 특성은 괄호의 유효한 구조와 일치한다.

따라서 자연어로 먼저 풀어보면 이렇게 풀 수 있다.
